...
def main():
    ...
    with st.sidebar.expander("Disclaimer",expanded=True,icon="⚠️"):
        disclaimer = """
                    ...
                    <strong>Furthermore, please be aware that the LLM may generate inaccurate or incorrect information. You assume full responsibility for how you use any generated output.</strong><br>
